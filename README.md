...
This is a fork of the seemingly unmaintained community lifeboat modpack for kerbal space program. It focuses on adding a few mods and changing some mods for more modern replacements.
...
It is now in good shape and can be shared and use, it should be relatively straightforward. Enjoy!!!
...
- You can also now add any other paid mods you have as well, like the ones from [Fossilized.](https://www.patreon.com/cw/FossilizedKSP), if you would like..
